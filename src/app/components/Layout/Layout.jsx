                ...
                <div className='flex justify-between gap-x-[26px]'>
                    ...
                    <div className='grow'>
                        <div className='py-7 px-[25px] border border-[#343942] rounded-md mt-[26px]'>
                            ...
                            <h2 className='text-[32px] text-[#EE5F2E] font-bold py-6 border-b border-[#282C31]'>
                            ...
                            <div className='py-6 border-b border-[#282C31]'>
                                ...
                                <div className='grid grid-cols-6 gap-x-5 gap-y-6 max-w-[316px]'>
                                    <Image src={html} width="36px" height="36px" />
                                    <Image src={css} width="36px" height="36px" />
                                    <Image src={js} width="36px" height="36px" />
                                    <Image src={bootstrap} width="36px" height="36px" />
                                    <Image src={react} width="36px" height="36px" />
                                    <Image src={webpack} width="36px" height="36px" />
                                    <Image src={git} width="36px" height="36px" />
                                    <Image src={sass} width="36px" height="36px" />
                                    <Image src={ts} width="36px" height="36px" />
                                    <Image src={tailwind} width="36px" height="36px" />
                                    <Image src={github} width="36px" height="36px" />
                                    <Image src={vite} width="36px" height="36px" />
                                </div>
                            </div>
